...
public class NewClient extends javax.swing.JFrame {
    ...
    private boolean isPhoneUnique(String str) {
        ...
        try {
            ...
            ps = con.prepareStatement("SELECT * FROM client WHERE phone = ?");
            ps.setString(1, str);
            rs = ps.executeQuery();
            if (rs.next()) {
                return false;
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        if (validation()) {
            ...
            try {
                ...
                ps = con.prepareStatement("INSERT INTO client(surname, name, patronymic, phone, city, street, zip, percent) VALUES(?, ?, ?, ?, ?, ?, ?, ?) ");
